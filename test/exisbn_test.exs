defmodule ExisbnTest do
  ...
  describe "979 prefix coverage" do
    ...
    test "unassigned 979 group: valid? returns true, metadata returns unknown_group" do
      # 9799012345674 is structurally valid (passes checkdigit) but its group
      # is not yet assigned in the ISBN standard — dataset correctly returns unknown_group.
      assert Exisbn.valid?("9799012345674")
